"use strict";
(self["webpackChunkProxy"] = self["webpackChunkProxy"] || []).push([["style_index_js"],{
...
// Module
___CSS_LOADER_EXPORT___.push([module.id, ".jp-ReactWidget {\n  color: var(--jp-ui-font-color1);\n  background: var(--jp-layout-color1);\n  font-size: 48px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  text-align: center;\n  background-color: AliceBlue;\n\n}\n", "",{"version":3,"sources":["webpack://./style/base.css"],"names":[],"mappings":"AAAA;EACE,+BAA+B;EAC/B,mCAAmC;EACnC,eAAe;EACf,aAAa;EACb,mBAAmB;EACnB,uBAAuB;EACvB,kBAAkB;EAClB,2BAA2B;;AAE7B","sourcesContent":[".jp-ReactWidget {\n  color: var(--jp-ui-font-color1);\n  background: var(--jp-layout-color1);\n  font-size: 48px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  text-align: center;\n  background-color: AliceBlue;\n\n}\n"],"sourceRoot":""}]);
// Exports
...
//# sourceMappingURL=style_index_js.f0c03b88959fa69c800f.js.map